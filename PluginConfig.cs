...
public class PluginConfig
{
    ...
    public static void Init(ConfigFile configFile)
    {
        ...
        ConfigMeleeSpeedMaximum = configFile.Bind("MeleeModule", "MeleeMoveSpeedMaximum", 10f, "Set move speed gained after dealing melee damage, this will happen A LOT be careful (ex 0.02 = 2%), 0-3.402823E+38");

        ConfigMeleeAtkSpeed = configFile.Bind("MeleeModule", "MeleeAtkSpeed", .2f, "Set the maximum speed boost, 0-3.402823E+38");
